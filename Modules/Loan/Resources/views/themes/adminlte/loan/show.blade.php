        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{url('loan')}}">{{ trans_choice('loan::general.loan',2) }}</a>
                    </li>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="float-right btn-group">
                                ...
                                <a href="#" data-bs-toggle="modal" data-target="#ceo_approve_loan_modal" class="btn btn-primary"><i class="fas fa-check"></i>
                                    {{ trans_choice('loan::general.approve',1) }}
                                </a>
                                <a href="#" data-bs-toggle="modal" data-target="#ceo_reject_loan_modal" class="btn btn-primary"><i class="fas fa-times"></i>
                                    {{ trans_choice('loan::general.reject',1) }}
                                </a>
                                <a href="#" data-bs-toggle="modal" data-target="#ceo_withdraw_loan_modal" class="btn btn-primary"><i class="fas fa-times"></i>
                                ...
                                <div class="modal fade" id="ceo_approve_loan_modal">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form method="post" action="{{ url('loan/'.$loan->id.'/approve_loan') }}">
                                                {{csrf_field()}}
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="approved_amount" class="form-control numeric" value="{{$loan->applied_amount}}" required="" id="approved_amount">
                                                    </div>
                                                    <div class="form-group">
                                ...
                                <div class="modal fade" id="ceo_reject_loan_modal">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                ...
                                <div class="modal fade" id="ceo_withdraw_loan_modal">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" name="loan_officer_id" id="loan_officer_id" v-model="loan_officer_id" required>
                                                            ...
                                                            <option value="{{$key->id}}" @if($key->id==$loan->loan_officer_id) selected @endif>{{$key->first_name}} {{$key->last_name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <form method="post" action="{{ url('loan/'.$loan->id.'/disburse_loan') }}" class="form-horizontal">
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        ...
                                                        <flat-pickr name="disbursed_on_date" value="{{$loan->expected_disbursement_date}}" class="form-control @error('disbursed_on_date') is-invalid @enderror" :required="true" id="rescheduled_from_date"></flat-pickr>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <flat-pickr name="first_payment_date" value="{{$loan->expected_first_payment_date}}" class="form-control @error('first_payment_date') is-invalid @enderror" :required="true" id="first_payment_date"></flat-pickr>
                                                    </div>
                                                    <div class="form-group">
            ...
            <div class="card card-primary card-outline card-outline-tabs">
                <div class="card-header p-0 border-bottom-0">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a href="#account_details" class="nav-link active" data-bs-toggle="tab">
                                {{ trans_choice('loan::general.account',1) }} {{ trans_choice('core::general.detail',2) }}
                            </a>
                        </li>
                        @if($loan->status=='active' ||$loan->status=='closed'||$loan->status=='written_off'||$loan->status=='overpaid'||$loan->status=='rescheduled')
                        <li class="nav-item">
                            <a href="#repayment_schedule" class="nav-link" data-bs-toggle="tab">
                                {{ trans_choice('loan::general.repayment',1) }} {{ trans_choice('loan::general.schedule',1) }}
                            </a>
                        </li>
                        @can('loan.loans.transactions.index')
                        <li class="nav-item">
                            <a href="#loan_transactions" class="nav-link" data-bs-toggle="tab">
                        ...
                        <li class="nav-item">
                            <a href="#loan_charges" class="nav-link" data-bs-toggle="tab">
                        ...
                        <li class="nav-item">
                            <a href="#loan_files" class="nav-link" data-bs-toggle="tab">
                        ...
                        <li class="nav-item">
                            <a href="#loan_collateral" class="nav-link" data-bs-toggle="tab">
                        ...
                        <li class="nav-item">
                            <a href="#loan_guarantors" class="nav-link" data-bs-toggle="tab">
                        ...
                        <li class="nav-item">
                            <a href="#loan_notes" class="nav-link" data-bs-toggle="tab">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="repayment_schedule">
                            <div class="m-4">
                                <div class="btn-group">
                                    <button href="#" class="btn btn-info dropdown-toggle" data-bs-toggle="dropdown">
                                        {{trans_choice('core::general.action',1)}}
                                    </button>
                                    <div class="dropdown-menu dropdown-menu-left">
                                        <a href="{{url('loan/'.$loan->id.'/schedule/email')}}" class="dropdown-item confirm">
                                            <i class="fas fa-envelope"></i>
                                            {{trans_choice('core::general.email',1)}} {{trans_choice('loan::general.schedule',1)}}
                                        </a>

                                        <a href="{{url('loan/'.$loan->id.'/schedule/print')}}" class="dropdown-item" target="_blank">
                                            <i class="fas fa-print"></i>
                                            {{trans_choice('core::general.print',1)}} {{trans_choice('loan::general.schedule',1)}}
                                        </a>

                                        <a href="{{url('loan/'.$loan->id.'/schedule/pdf')}}" class="dropdown-item" target="_blank">
                            ...
                            <table class="pretty displayschedule" id="repaymentschedule" style="margin-top: 20px;">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="highlightcol" scope="colgroup" colspan="3">{{trans_choice('loan::general.loan_amount_and_balance',1)}}</th>
                                        <th class="highlightcol" scope="colgroup" colspan="3">{{trans_choice('loan::general.total_cost_of_loan',1)}}</th>
                                    ...
                                    <tr>
                                        ...
                                        <th class="righthighlightcolheader" scope="col">{{trans_choice('loan::general.principal',1)}} {{trans_choice('loan::general.balance',1)}}</th>

                                        <th class="lefthighlightcolheader" scope="col">{{trans_choice('loan::general.interest',1)}} {{trans_choice('loan::general.due',1)}}</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$days}}</td>
                                        <td>
                                            @if($outstanding<=0) <span style="@if(\Illuminate\Support\Carbon::parse($key->paid_by_date)->greaterThan(\Illuminate\Support\Carbon::parse($key->due_date)))color: #eb2442; @endif">{{$key->paid_by_date}}</span>
                                        ...
                                        <td>
                                            @if($outstanding<=0) @if(\Illuminate\Support\Carbon::parse($key->paid_by_date)->greaterThan(\Illuminate\Support\Carbon::parse($key->due_date)))
                            ...
                            <table class="table table-striped table-hover" id="loan_transactions_table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button href="#" class="btn btn-default dropdown-toggle" data-bs-toggle="dropdown">
                                                    <i class="fas fa-ellipsis-h"></i>
                                                </button>
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a href="{{url('loan/transaction/' . $key->id . '/show') }}" class="dropdown-item"><i class="fas fa-eye"></i> {{ trans_choice('core::general.view', 2) }}
                                                    </a>
                                                    @if($key->loan_transaction_type_id == 2 && $key->reversed==0)
                                                    <a href="{{url('loan/transaction/' . $key->id . '/pdf') }}" target="_blank" class="dropdown-item"><i class="fas fa-file-pdf"></i> {{ trans_choice('core::general.receipt', 1) }}
                                                    </a>
                                                    <a href="{{url('loan/transaction/' . $key->id . '/print') }}" target="_blank" class="dropdown-item"><i class="fas fa-print"></i> {{ trans_choice('core::general.print', 1) }}
                                                    </a>
                                                    @can('loan.loans.transactions.edit')
                                                    <a href="{{url('loan/repayment/' . $key->id . '/edit') }}" class="dropdown-item"><i class="fas fa-edit"></i> {{ trans_choice('core::general.edit', 1) }}
                                                    </a>

                                                    @endcan
                                                    @can('loan.loans.transactions.edit')

                                                    <a href="{{url('loan/repayment/' . $key->id . '/reverse') }}" class="dropdown-item confirm"><i class="fas fa-undo"></i> {{ trans_choice('loan::general.reverse', 1) }}
                                                    </a>
                        ...
                        <div class="tab-pane" id="loan_charges">
                            @can('loan.loans.charges.create')
                            <a href="{{url('loan/'.$loan->id.'/charge/create')}}" class="btn btn-info float-right m-2">{{trans_choice('core::general.add',1)}} {{trans_choice('loan::general.charge',1)}}</a>
                            @endcan
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                            @can('loan.loans.transactions.edit')
                                            <a href="{{url('loan/charge/'.$key->id.'/waive')}}" class="btn btn-danger confirm">
                        ...
                        <div class="tab-pane" id="loan_files">
                            ...
                            <a href="{{url('loan/'.$loan->id.'/file/create')}}" class="btn btn-info float-right m-2">{{trans_choice('core::general.add',1)}} {{trans_choice('loan::general.file',1)}}</a>
                            @endcan
                            <table class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{asset('storage/uploads/loans/'.$key->link)}}" target="_blank"><i class="fas fa-download"></i> </a>
                                            @can('loan.loans.files.edit')
                                            <a href="{{url('loan/file/'.$key->id.'/edit')}}"><i class="fas fa-edit"></i> </a>
                                            @endcan
                                            @can('loan.loans.files.destroy')
                                            <a href="{{url('loan/file/'.$key->id.'/destroy')}}" class="confirm"><i class="fas fa-trash"></i> </a>
                                            @endcan
                                        </td>
                                    </tr>
                                    @endforeach
                        ...
                        <div class="tab-pane" id="loan_collateral">
                            ...
                            <a href="{{url('loan/'.$loan->id.'/collateral/create')}}" class="btn btn-info float-right m-2">{{trans_choice('core::general.add',1)}} {{trans_choice('loan::general.collateral',1)}}</a>
                            @endcan
                            <table class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{url('loan/collateral/'.$key->id.'/edit')}}"><i class="fas fa-edit"></i> </a>
                                            @endcan
                                            @can('loan.loans.collateral.destroy')
                                            <a href="{{url('loan/collateral/'.$key->id.'/destroy')}}" class="confirm"><em class="fas fa-trash"></em> </a>
                                            @endcan
                                        </td>
                                    </tr>
                                    @endforeach
                        ...
                        <div class="tab-pane" id="loan_guarantors">
                            ...
                            <a href="{{url('loan/'.$loan->id.'/guarantor/create')}}" class="btn btn-info float-right m-2">{{trans_choice('core::general.add',1)}} {{trans_choice('loan::general.guarantor',1)}}</a>
                            @endcan
                            <table class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($key->is_client==1)
                                            <a href="{{url('client/'.$key->client_id.'/show')}}"><i class="fas fa-eye"></i> </a>
                                            @else
                                            <a href="{{url('loan/guarantor/'.$key->id.'/show')}}"><i class="fas fa-eye"></i> </a>
                                            @endif
                                            @can('loan.loans.guarantors.edit')
                                            <a href="{{url('loan/guarantor/'.$key->id.'/edit')}}"><i class="fas fa-edit"></i> </a>
                                            @endcan
                                            @can('loan.loans.guarantors.destroy')
                                            <a href="{{url('loan/guarantor/'.$key->id.'/destroy')}}" class="confirm"><i class="fas fa-trash"></i> </a>
                                            @endcan
                                        </td>
                                    </tr>
                                    @endforeach
                        ...
                        <div class="tab-pane" id="loan_notes">
                            ...
                            <a href="{{url('loan/'.$loan->id.'/note/create')}}" class="btn btn-info float-right m-2">{{trans_choice('core::general.add',1)}} {{trans_choice('core::general.note',1)}}</a>
                            @endcan
                                ...
                                <div class="media pt-2">
                                    <div class="media-body">
                                        ...
                                        <p>
                                            ...
                                            <a href="{{url('loan/note/'.$key->id.'/edit')}}" class="btn btn-xs btn-tool"><i class="fas fa-edit"></i> </a>
                                            @endcan
                                            @can('loan.loans.notes.destroy')
                                            <a href="{{url('loan/note/'.$key->id.'/destroy')}}" class="btn btn-xs btn-tool link-danger confirm"><i class="fas fa-trash"></i> </a>
                                            @endcan
                                        </p>
                                    </div>
                                </div>
...
<script>
    var app = new Vue({
        ...
        data: {
            ...
            rescheduled_on_date: '{{old('
            rescheduled_on_date ',date('
            Y - m - d '))}}',
            rescheduled_from_date: '{{old('
            rescheduled_from_date ')}}',
            rescheduled_first_payment_date: '{{old('
