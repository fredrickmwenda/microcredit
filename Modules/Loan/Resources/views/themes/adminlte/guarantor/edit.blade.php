        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{url('loan/'.$loan_guarantor->loan_id.'/show')}}">{{ trans_choice('loan::general.loan',2) }}</a>
                    </li>
                    <li class="breadcrumb-item active">{{ trans_choice('core::general.edit',1) }} {{ trans_choice('loan::general.guarantor',1) }}</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="card card-bordered card-preview">
            <div class="card-body">
                <div class="form-group">
                    <label for="is_client" class="control-label">{{trans_choice('loan::general.is_client',1)}}</label>
                ...
                <div v-if="is_client=='1'">
                    <div class="form-group">
                        <label for="client_id" class="control-label">{{trans_choice('client::general.client',1)}}</label>
                        <v-select label="name_id" :options="clients" :reduce="client => client.id" v-model="client_id">
                            <template #search="{attributes, events}">
                                <input autocomplete="off" class="vs__search @error('client_id') is-invalid @enderror" v-bind="attributes" :required="!client_id" v-on="events" />
                            </template>
                        </v-select>
                ...
                <div v-if="is_client=='0'">
                    <div class="form-group">
                        <label for="client_relationship_id" class="control-label">{{trans_choice('client::general.relationship',1)}}</label>
                        <v-select label="name" :options="client_relationships" :reduce="client_relationship => client_relationship.id" v-model="client_relationship_id">
                            <template #search="{attributes, events}">
                                <input autocomplete="off" class="vs__search @error('client_relationship_id') is-invalid @enderror" v-bind="attributes" :required="!client_relationship_id" v-on="events" />
                            </template>
                        </v-select>
                    ...
                    <div class="form-group">
                        ...
                        <v-select label="name" :options="titles" :reduce="title => title.id" v-model="title_id">
                            <template #search="{attributes, events}">
                                <input autocomplete="off" class="vs__search @error('title_id') is-invalid @enderror" v-bind="attributes" v-on="events" />
                            </template>
                        </v-select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('gender') is-invalid @enderror" name="gender" id="gender" v-model="gender" required>
                    ...
                    <div class="form-group">
                        ...
                        <v-select label="name" :options="countries" :reduce="country => country.id" v-model="country_id">
                            <template #search="{attributes, events}">
                                <input autocomplete="off" class="vs__search @error('country_id') is-invalid @enderror" v-bind="attributes" v-on="events" />
                            </template>
                        </v-select>
                    ...
                    <div class="form-group">
                        ...
                        <v-select label="name" :options="professions" :reduce="profession => profession.id" v-model="profession_id">
                            <template #search="{attributes, events}">
                                <input autocomplete="off" class="vs__search @error('profession_id') is-invalid @enderror" v-bind="attributes" v-on="events" />
                            </template>
                        </v-select>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="guaranteed_amount" value="{{ old('guaranteed_amount') }}" id="guaranteed_amount" v-model="guaranteed_amount" class="form-control @error('guaranteed_amount') is-invalid @enderror numeric">
    ...
    var app = new Vue({
        ...
        data: {
            ...
            client_relationships: {
                !!json_encode($client_relationships) !!
            },
            titles: {
                !!json_encode($titles) !!
            },
            professions: {
                !!json_encode($professions) !!
            },
            countries: {
