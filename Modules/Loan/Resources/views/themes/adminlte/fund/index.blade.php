...
@section('title')
    {{ trans_choice('loan::general.loan',1) }}  {{ trans_choice('loan::general.fund',2) }}
@endsection
@section('styles')
@stop
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ trans_choice('loan::general.loan',1) }}  {{ trans_choice('loan::general.fund',2) }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('loan::general.loan',1) }}  {{ trans_choice('loan::general.fund',2) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                ...
                @can('loan.loans.funds.create')
                    <a href="{{ url('loan/fund/create') }}" class="btn btn-info btn-sm">
                        <i class="fas fa-plus"></i> {{ trans_choice('core::general.add',1) }} {{ trans_choice('loan::general.fund',1) }}
                    </a>
                @endcan
                <div class="btn-group">
                    <div class="dropdown">
                ...
                <div class="card-tools">
                    <form class="form-inline ml-0 ml-md-3" action="{{url('loan/fund')}}">
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        @can('loan.loans.funds.edit')
                                            <a href="{{url('loan/fund/' . $key->id . '/edit')}}"
                                               class="dropdown-item">
                                        ...
                                        @can('loan.loans.funds.destroy')
                                            <a href="{{url('loan/fund/' . $key->id . '/destroy')}}"
