...
@section('title')
    {{ trans_choice('loan::general.collateral',1) }}  {{ trans_choice('core::general.type',2) }}
@endsection
@section('styles')
@stop
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ trans_choice('loan::general.collateral',1) }}  {{ trans_choice('core::general.type',2) }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('loan::general.collateral',1) }}  {{ trans_choice('core::general.type',2) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="card">
            <div class="card-header">
                ...
                @can('loan.loans.collateral_types.create')
                    <a href="{{ url('loan/collateral_type/create') }}" class="btn btn-info btn-sm">
                ...
                <div class="card-tools">
                    <form class="form-inline ml-0 ml-md-3" action="{{url('loan/collateral_type')}}">
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        @can('loan.loans.collateral_types.edit')
                                            <a href="{{url('loan/collateral_type/' . $key->id . '/edit')}}"
                                               class="dropdown-item">
                                        ...
                                        @can('loan.loans.collateral_types.destroy')
                                            <a href="{{url('loan/collateral_type/' . $key->id . '/destroy')}}"
