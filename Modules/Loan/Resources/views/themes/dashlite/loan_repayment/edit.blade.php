...
@section('content')
        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">{{ trans_choice('core::general.edit',1) }} {{ trans_choice('loan::general.repayment',1) }}</h3>
    ...
    <div class="nk-block nk-block-lg" id="app">
        <form method="post" action="{{ url('loan/repayment/'.$loan_transaction->id.'/update') }}">
            {{csrf_field()}}
    ...
    <script>
        ...
        var app = new Vue({
            ...
            data: {
                ...
                payment_type_id: parseInt("{{old('payment_type_id',$loan_transaction->payment_detail->payment_type_id)}}"),
