    ...
    <div class="nk-block-head-content">
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">{{ trans_choice('loan::general.loan',1) }}  {{ trans_choice('loan::general.charge',2) }}</h3>
                    <div class="nk-block-des text-soft">
                        <p>{{number_format($data->total())}} {{ trans_choice('loan::general.charge',2) }} {{ trans_choice('core::general.found',1) }}</p>
                    </div>
                        ...
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col tb-col-mb">
                                <a href="{{table_order_link('loan_charge_type_id')}}">
                                    <span class="sub-text">{{ trans_choice('loan::general.charge',1) }} {{ trans_choice('core::general.type',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-mb">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <ul class="link-list-opt no-bdr">
                                                        @can('loan.loans.charges.edit')
                                                            <li>
                                                                <a href="{{url('loan/charge/' . $key->id . '/edit')}}">
