    ...
    <div class="nk-block-head-content">
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">{{ trans_choice('loan::general.loan',1) }}  {{ trans_choice('loan::general.fund',2) }}</h3>
                    <div class="nk-block-des text-soft">
                        <p>{{number_format($data->total())}} {{ trans_choice('loan::general.fund',2) }} {{ trans_choice('core::general.found',1) }}</p>
                    </div>
                                ...
                                <li class="nk-block-tools-opt">
                                    @can('loan.loans.funds.create')
                                        <a href="{{ url('loan/fund/create') }}" class="btn btn-info btn-sm">
                                            {{ trans_choice('core::general.add',1) }} {{ trans_choice('loan::general.fund',1) }}
                                        </a>
                                    @endcan
                                </li>
                            </ul>
