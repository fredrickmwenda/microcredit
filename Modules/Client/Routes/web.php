...
Route::prefix('client')->group(function () {
    ...
    Route::get('dormant_clients', 'ClientController@getDormantClients');
    Route::get('client_deposit_report', 'ClientController@getClientTotalDepositReport');
    Route::get('client_balance_report', 'ClientController@getClientBalanceReport');
    Route::get('client_balance_statement', 'ClientController@getClientStatement');
    Route::get('client_saving_statement', 'ClientController@getClientSavingStatement');
    Route::get('client_saving_summery', 'ClientController@getClientSavingSummery');
    Route::get('client_loan_statement', 'ClientController@getClientLoanStatement');
    Route::get('client_loan_summery', 'ClientController@getClientLoanSummery');
    Route::get('client_info', 'ClientController@getClientInfo');

    Route::get('client_excel_import', 'ClientController@clientFileExportImport');
    Route::post('client_import', 'ClientController@clientExcelImport')->name('client_import');
    Route::get('file-export', 'ClientController@fileExport')->name('file-export');
