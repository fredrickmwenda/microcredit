...
@section('title')
    {{ trans_choice('client::general.title',2) }}
@endsection
@section('styles')
@stop
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ trans_choice('client::general.client',1) }}  {{ trans_choice('client::general.title',2) }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('client::general.client',1) }}  {{ trans_choice('client::general.title',2) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                @can('client.clients.titles.create')
                    <a href="{{ url('client/title/create') }}" class="btn btn-info btn-sm">
                ...
                <div class="card-tools">
                    <form class="form-inline ml-0 ml-md-3" action="{{url('client/title')}}">
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        @can('client.clients.titles.edit')
                                            <a href="{{url('client/title/' . $key->id . '/edit')}}" class="dropdown-item">
                                                <i class="ri-edit-fill"></i>
                                                <span>{{trans_choice('core::general.edit',1)}}</span>
                                            </a>
                                        @endcan
                                        <div class="divider"></div>
                                        @can('client.clients.titles.destroy')
                                            <a href="{{url('client/title/' . $key->id . '/destroy')}}"
