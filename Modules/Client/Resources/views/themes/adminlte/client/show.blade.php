            ...
            <div class="card card-bordered card-preview">
                <div class="card-body box-profile">
                    ...
                    <div class="text-center">
                        ...
                        <a href="{{ asset('storage/uploads/clients/'.$client->signature_pad) }}" class="fancybox">
                            <img
                                class="profile-user-img img-fluid signature-box"
                                src="{{ asset('storage/uploads/clients/'.$client->signature_pad) }}"
    ...
    $(document).ready(function() {
        ...
        $('#savings-data-table').DataTable({
            ...
            columns : [{
                ...
                {
                    data: 'savings_product',
                    name: 'savings_products.name'
                },
                {
                    data: 'action',
                    name: 'action',
