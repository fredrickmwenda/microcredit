            ...
            <div class="card card-bordered card-preview">
                <div class="card-body">
                    <div class="row gy-4">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="place_of_workship" id="place_of_workship" v-model="place_of_workship"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="spouse_name"
                                       class="control-label">Spouse Name</label>
                                <input type="text" name="spouse_name" id="spouse_name" v-model="spouse_name"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="spouse_contact"
                                       class="control-label">Spouse Mobile</label>
                                <input type="text" name="spouse_contact" id="spouse_contact" v-model="spouse_contact"
