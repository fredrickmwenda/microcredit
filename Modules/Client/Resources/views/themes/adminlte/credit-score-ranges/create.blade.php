...
@section('title')
    {{ trans_choice('core::general.add',1) }} {{ trans_choice('core::general.credit_score_range',1) }}
@endsection
@section('content')
    ...
    <section class="content">
        <form method="post" action="{{ url('client/credit_score_range/store') }}">
            {{csrf_field()}}
                    ...
                    <div class="row gy-4">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="min_score" id="min_score" class="form-control numeric" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="max_score" class="control-label">{{ trans_choice('core::general.max',1) }} {{ trans_choice('core::general.score',1) }}</label>
                                <input type="number" name="max_score" id="max_score" class="form-control numeric" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="sort_order" class="control-label">{{ trans_choice('core::general.order',1) }}</label>
                                <input type="number" name="sort_order" id="sort_order" class="form-control numeric" value="0" required>
                            </div>
                        </div>
                    </div>
                    <div class="row gy-4">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="rating_label" id="rating_label" class="form-control" placeholder="e.g. Excellent" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="color_code" class="control-label">{{ trans_choice('core::general.color',1) }}</label>
                                <input type="color" name="color_code" id="color_code" class="form-control" value="#22c55e" required>
                            </div>
                        </div>
                    </div>
                    <div class="row gy-4">
