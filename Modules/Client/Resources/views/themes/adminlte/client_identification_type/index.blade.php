...
@section('title')
    {{ trans_choice('client::general.client',1) }} {{ trans_choice('client::general.identification',1) }}  {{ trans_choice('client::general.type',2) }}
@endsection
@section('styles')
@stop
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ trans_choice('client::general.client',1) }} {{ trans_choice('client::general.identification',1) }}  {{ trans_choice('client::general.type',2) }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('client::general.client',1) }} {{ trans_choice('client::general.identification',1) }}  {{ trans_choice('client::general.type',2) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                @can('client.clients.identification_types.create')
                    <a href="{{ url('client/client_identification_type/create') }}" class="btn btn-info btn-sm">
                ...
                <div class="card-tools">
                    <form class="form-inline ml-0 ml-md-3" action="{{url('client/client_identification_type')}}">
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        @can('client.clients.identification_types.edit')
                                            <a href="{{url('client/client_identification_type/' . $key->id . '/edit')}}" class="dropdown-item">
                                                <i class="ri-edit-fill"></i>
                                                <span>{{trans_choice('core::general.edit',1)}}</span>
                                            </a>
                                        @endcan
                                        <div class="divider"></div>
                                        @can('client.clients.identification_types.destroy')
                                            <a href="{{url('client/client_identification_type/' . $key->id . '/destroy')}}"
