    ...
    <div class="nk-block-head-content">
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">  {{ trans_choice('client::general.client',1) }} {{ trans_choice('client::general.identification',1) }}  {{ trans_choice('client::general.type',2) }}</h3>
                    <div class="nk-block-des text-soft">
                        <p>{{number_format($data->total())}} {{ trans_choice('client::general.type',2) }} {{ trans_choice('core::general.found',1) }}</p>
                    </div>
            ...
            <div class="card-inner-group">
                <div class="card-inner position-relative card-tools-toggle">
                    ...
                    <div class="card-search search-wrap" data-search="search">
                        <div class="card-body">
                            <form method="get"
                                  action="{{url('client/client_identification_type')}}">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <ul class="link-list-opt no-bdr">
                                                        @can('client.clients.identification_types.edit')
                                                            <li>
                                                                <a href="{{url('client/client_identification_type/' . $key->id . '/edit')}}">
