    ...
    <div class="nk-block-head-content">
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title"> {{ trans_choice('client::general.profession',2) }}</h3>
                    <div class="nk-block-des text-soft">
                        <p>{{number_format($data->total())}} {{ trans_choice('client::general.profession',2) }} {{ trans_choice('core::general.found',1) }}</p>
                    </div>
                                ...
                                <li class="nk-block-tools-opt">
                                    @can('client.clients.professions.create')
                                        <a href="{{ url('client/profession/create') }}" class="btn btn-info btn-sm">
                                            {{ trans_choice('core::general.add',1) }} {{ trans_choice('client::general.profession',1) }}
                                        </a>
                                    @endcan
                                </li>
                            </ul>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <ul class="link-list-opt no-bdr">
                                                        @can('client.clients.professions.edit')
                                                            <li>
                                                                <a href="{{url('client/profession/' . $key->id . '/edit')}}">
