        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">{{ trans_choice('core::general.edit',1) }} {{ trans_choice('client::general.client',1) }}</h3>
...
@section('scripts')
    <script>
        var app = new Vue({
            el: "#app",
            data: {
                branch_id: "{{old('branch_id',$client->branch_id)}}",
                ...
                country_id: "{{old('country_id',$client->country_id)}}",
                mobile: "{{old('mobile',$client->mobile)}}",
                dob: "{{old('dob',$client->dob)}}",
                loan_officer_id: "{{old('loan_officer_id',$client->loan_officer_id)}}",
                email: "{{old('email',$client->email)}}",
                profession_id: "{{old('profession_id',$client->profession_id)}}",
                client_type_id: "{{old('client_type_id',$client->client_type_id)}}",
