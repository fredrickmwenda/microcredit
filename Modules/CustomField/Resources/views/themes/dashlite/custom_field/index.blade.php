    ...
    <div class="nk-block-head-content">
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">{{ trans_choice('customfield::general.custom_field',2) }}</h3>
                    <div class="nk-block-des text-soft">
                        <p>{{number_format($data->total())}} {{ trans_choice('customfield::general.custom_field',2) }} {{ trans_choice('core::general.found',1) }}</p>
                    </div>
                        ...
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col tb-col-md">
                                <a href="{{table_order_link('category')}}">
                                    <span class="sub-text">{{ trans_choice('customfield::general.category',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-md">
                                <a href="{{table_order_link('type')}}">
                                    <span class="sub-text">{{ trans_choice('customfield::general.type',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-md">
                                <a href="{{table_order_link('required')}}">
                                    <span class="sub-text">{{ trans_choice('customfield::general.required',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-md">
                                            ...
                                            <div class="drodown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <ul class="link-list-opt no-bdr">
                                                        <li>
                                                            <a href="{{url('custom_field/' . $key->id . '/show')}}">
