...
@section('title')
    {{ trans_choice('core::general.edit',1) }} {{ trans_choice('core::general.branch',1) }}/ Team
@endsection
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a
                                    href="{{url('branch')}}">{{ trans_choice('core::general.branch',2) }}/ Teams</a>
                        </li>
                        <li class="breadcrumb-item active">{{ trans_choice('core::general.edit',1) }} {{ trans_choice('core::general.branch',1) }}/ Team</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
