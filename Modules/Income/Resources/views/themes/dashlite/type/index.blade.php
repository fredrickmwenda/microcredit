...
@section('title')
    {{ trans_choice('income::general.income',1) }}  {{ trans_choice('income::general.type',2) }}
@endsection
@section('styles')
@stop
@section('content')
    <div class="nk-block-head-content">
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title"> {{ trans_choice('income::general.income',1) }}  {{ trans_choice('expense::general.type',2) }}</h3>
                    <div class="nk-block-des text-soft">
                        <p>{{number_format($data->total())}} {{ trans_choice('core::general.type',2) }} {{ trans_choice('core::general.found',1) }}</p>
                    </div>
                        ...
                        <div class="toggle-expand-content" data-content="pageMenu">
                            <ul class="nk-block-tools g-3">
                                ...
                                <li class="nk-block-tools-opt">
                                    @can('income.income.types.create')
                                        <a href="{{ url('income/type/create') }}" class="btn btn-info btn-sm">
                    ...
                    <div class="nk-tb-list nk-tb-ulist is-compact">
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col tb-col-md">
                                <a href="{{table_order_link('asset_chart_of_account_id')}}">
                                    <span class="sub-text">{{ trans_choice('accounting::general.asset',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-md">
                                <a href="{{table_order_link('income_chart_of_account_id')}}">
                                    <span class="sub-text">{{ trans_choice('accounting::general.income',1) }}</span>
                                </a>
                            </div>
                        ...
                        @foreach($data as $key)
                            <div class="nk-tb-item">
                                ...
                                <div class="nk-tb-col tb-col-mb">
                                    <span>{{$key->asset_chart_of_account}}</span>
                                </div>
                                <div class="nk-tb-col tb-col-mb">
                                    <span>{{$key->income_chart_of_account}}</span>
                                </div>
                                            ...
                                            <div class="drodown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <ul class="link-list-opt no-bdr">
                                                        @can('income.income.types.edit')
                                                            <li>
                                                                <a href="{{url('income/type/' . $key->id . '/edit')}}">
                                                        ...
                                                        @endcan
                                                        <li class="divider"></li>
                                                        @can('income.income.types.destroy')
                                                            <li>
                                                                <a href="{{url('income/type/' . $key->id . '/destroy')}}"
                                                                   class="confirm">
