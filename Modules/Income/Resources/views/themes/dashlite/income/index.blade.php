    ...
    <div class="nk-block-head-content">
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">  {{ trans_choice('income::general.income',1) }}</h3>
                    <div class="nk-block-des text-soft">
                        <p>{{number_format($data->total())}}  {{ trans_choice('income::general.income',1) }} {{ trans_choice('core::general.found',1) }}</p>
                    </div>
                    ...
                    <div class="nk-tb-list nk-tb-ulist is-compact">
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col tb-col-md">
                                <a href="{{table_order_link('income_type_id')}}">
                                    <span class="sub-text">{{trans_choice('income::general.income',1)}} {{trans_choice('core::general.type',1)}}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-md">
                                <a href="{{table_order_link('amount')}}">
                                    <span class="sub-text">{{trans_choice('income::general.amount',1)}}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-md">
