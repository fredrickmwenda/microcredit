    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>
                        {{ __('user::general.API Keys') }} / <strong
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ __('user::general.API Keys') }} / <strong
                                    class="text-primary small">{{ $user->first_name }} {{ $user->last_name }}</strong>
                        </li>
                    </ol>
                </div>
            ...
            <div class="col-md-9">
                ...
                <div class="card card-bordered card-preview">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('user::general.Oauth Clients') }}</h4>
                ...
                <div class="card card-bordered card-preview">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('user::general.Personal Access Tokens') }}</h4>
                        <div class="card-tools">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>This API Key can be used to gain an <code>access_token</code>, which can then be used to
                            interact
                            with the API.</p>
                    </div>
                    <div class="modal-footer">
