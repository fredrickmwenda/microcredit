...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ trans_choice('user::general.role',2) }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('user::general.role',2) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="card-header">
                @can('user.roles.create')
                    <a href="{{ url('user/role/create') }}" class="btn btn-info btn-sm">
                        <i class="fas fa-plus"></i> {{ trans_choice('core::general.add',1) }} {{ trans_choice('user::general.role',1) }}
                    </a>
                @endcan
                <div class="btn-group">
                    <div class="dropdown">
                ...
                <div class="card-tools">
                    <form class="form-inline ml-0 ml-md-3" action="{{url('user/role')}}">
