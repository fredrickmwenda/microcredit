...
@section('title')
    {{ trans_choice('user::general.role',2) }}
@endsection
@section('styles')
@stop
@section('content')
    <div class="nk-block-head-content">
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">{{ trans_choice('user::general.role',2) }}</h3>
                    <div class="nk-block-des text-soft">
                        <p>{{number_format($data->total())}} {{ trans_choice('user::general.role',2) }} {{ trans_choice('core::general.found',1) }}</p>
                    </div>
                ...
                <div class="card-inner p-0">
                    <div class="nk-tb-list nk-tb-ulist is-compact">
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col tb-col-mb">
                                <span
                                        class="sub-text">{{ trans_choice('user::general.system',1) }}</span>
                            </div>
                        ...
                        @foreach($data as $key)
                            <div class="nk-tb-item">
                                ...
                                <div class="nk-tb-col  tb-col-mb">
                                    <a href="{{url('user/role/'.$key->id.'/show')}}">
                                        <span>{{$key->name}}</span>
                                    </a>
                                </div>
                                <div class="nk-tb-col tb-col-md">
                                    @if($key->is_system==1)
                                        <span class="badge badge-success">
                                            {{trans_choice('core::general.yes',2)}}
                                        </span>
                                    @else
                                        <span class="badge badge-danger">
                                            {{trans_choice('core::general.no',2)}}
                                        </span>
                                    @endif
                                </div>
                                            ...
                                            <div class="drodown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <ul class="link-list-opt no-bdr">
                                                        ...
                                                        @can('user.roles.edit')
                                                            <li>
                                                                <a href="{{url('user/role/' . $key->id . '/edit')}}">
                                                        ...
                                                        @endcan
                                                        <li class="divider"></li>
                                                        @can('user.roles.destroy')
                                                            <li>
                                                                <a href="{{url('user/role/' . $key->id . '/destroy')}}"
                                                                   class="confirm">
