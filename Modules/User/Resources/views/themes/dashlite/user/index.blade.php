    ...
    <div class="nk-block-head-content">
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">{{ trans_choice('user::general.user',2) }}</h3>
                    <div class="nk-block-des text-soft">
                        <p>{{number_format($data->total())}} {{ trans_choice('user::general.user',2) }} {{ trans_choice('core::general.found',1) }}</p>
                    </div>
                    ...
                    <div class="nk-tb-list nk-tb-ulist is-compact">
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col tb-col-mb"><span
                                        class="sub-text">{{ trans_choice('core::general.avatar',1) }}</span></div>
                            ...
                            <div class="nk-tb-col tb-col-lg">
                                <a href="{{table_order_link('email')}}">
                                    <span class="sub-text">{{ trans_choice('core::general.email',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-lg"><span
                                        class="sub-text">{{ trans_choice('user::general.role',2) }}</span></div>
                            <div class="nk-tb-col tb-col-lg">
                                <a href="{{table_order_link('first_name')}}">
                                    <span class="sub-text">{{ trans('core::general.created_at') }}</span>
                                </a>
                            </div>
