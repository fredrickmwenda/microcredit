...
@section('title')
    {{ trans_choice('wallet::general.wallet',2) }}
@endsection
@section('styles')
@stop
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ trans_choice('wallet::general.wallet',2) }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('wallet::general.wallet',2) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                @can('wallet.wallets.create')
                    <a href="{{ url('wallet/create') }}" class="btn btn-info btn-sm">
                        <i class="fas fa-plus"></i> {{ trans_choice('core::general.add',1) }} {{ trans_choice('wallet::general.wallet',1) }}
                    </a>
                @endcan
                <div class="btn-group">
                    <div class="dropdown">
                ...
                <div class="card-tools">
                    <form class="form-inline ml-0 ml-md-3" action="{{url('wallet')}}">
                    ...
                    <tr>
                        ...
                        <th>
                            <a href="{{table_order_link('branch')}}">
                                <span>{{ trans_choice('core::general.branch',1) }}/ Tean</span>
                            </a>
                        </th>
                        <th>
                        ...
                        <th>
                            <a href="{{table_order_link('balance')}}">
                                <span>{{ trans_choice('wallet::general.balance',1) }}</span>
                            </a>
                        </th>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a href="{{url('wallet/' . $key->id . '/show')}}" class="dropdown-item">
