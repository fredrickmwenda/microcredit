    ...
    <div class="nk-block-head-content">
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">{{ trans_choice('core::general.currency',2) }}</h3>
                    <div class="nk-block-des text-soft">
                        <p>{{number_format($data->total())}} {{ trans_choice('core::general.currency',2) }} {{ trans_choice('core::general.found',1) }}</p>
                    </div>
                    ...
                    <div class="nk-tb-list nk-tb-ulist is-compact">
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col tb-col-md">
                                <a href="{{table_order_link('symbol')}}">
                                    <span class="sub-text">{{ trans_choice('core::general.symbol',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-md">
                                <a href="{{table_order_link('code')}}">
                                    <span class="sub-text">{{ trans_choice('core::general.code',1) }}</span>
                                </a>
                            </div>
                                            ...
                                            <div class="drodown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <ul class="link-list-opt no-bdr">
                                                        <li>
                                                            <a href="{{url('currency/' . $key->id . '/show')}}">
                                                        ...
                                                        @can('core.currencies.edit')
                                                            <li>
                                                                <a href="{{url('currency/' . $key->id . '/edit')}}">
