...
@section('title')
    {{ trans_choice('core::general.payment',1) }} {{ trans_choice('core::general.type',2) }}
@endsection
@section('styles')
@stop
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ trans_choice('core::general.payment',1) }} {{ trans_choice('core::general.type',2) }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('core::general.payment',1) }} {{ trans_choice('core::general.type',2) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <form class="form-inline ml-0 ml-md-3" action="{{url('payment_type')}}">
            ...
            <div class="card-body p-0">
                <table id="data-table" class="table table-striped table-condensed table-hover">
                    ...
                    @foreach($data as $key)
                        <tr>
                            <td>
                                <a href="{{url('payment_type/' . $key->id . '/show')}}">
                                    <span>{{$key->name}}</span>
                                </a>
                            </td>
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        @can('core.payment_types.edit')
                                            <a href="{{url('payment_type/' . $key->id . '/edit')}}"
                                               class="dropdown-item">
                                        ...
                                        @can('core.payment_types.destroy')
                                            <a href="{{url('payment_type/' . $key->id . '/destroy')}}"
