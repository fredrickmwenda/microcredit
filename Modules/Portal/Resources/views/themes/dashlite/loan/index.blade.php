    ...
    <div class="nk-block-head-content">
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">{{ trans_choice('loan::general.loan',2) }}</h3>
                    <div class="nk-block-des text-soft">
                        <p>{{number_format($data->total())}} {{ trans_choice('loan::general.loan',2) }} {{ trans_choice('core::general.found',1) }}</p>
                    </div>
                    ...
                    <div class="nk-tb-list nk-tb-ulist is-compact">
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col tb-col-mb">
                                <a href="{{table_order_link('loan_officer')}}">
                                    <span class="sub-text">{{ trans_choice('loan::general.loan_officer',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-mb">
                            ...
                            <div class="nk-tb-col tb-col-mb">
                                <a href="{{table_order_link('disbursed_on_date')}}">
                                    <span class="sub-text">{{ trans('loan::general.disbursed') }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-mb">
                        ...
                        @foreach($data as $key)
                            <div class="nk-tb-item">
                                <div class="nk-tb-col  tb-col-mb">
                                    <a href="{{url('portal/loan/'.$key->id.'/show')}}">
                                        <span>{{$key->id}}</span>
                                    </a>
                                </div>
                                <div class="nk-tb-col  tb-col-mb">
