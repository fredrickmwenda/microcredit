    ...
    <div class="nk-block-head-content">
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">{{ trans_choice('share::general.share',2) }}</h3>
                    <div class="nk-block-des text-soft">
                        <p>{{number_format($data->total())}} {{ trans_choice('share::general.share',2) }} {{ trans_choice('core::general.found',1) }}</p>
                    </div>
                        ...
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col tb-col-mb">
                                <a href="{{table_order_link('account_number')}}">
                                    <span class="sub-text">{{ trans_choice('savings::general.savings',1) }} {{ trans_choice('savings::general.account',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-mb">
                                <a href="{{table_order_link('approved_shares')}}">
                                    <span class="sub-text">{{ trans_choice('share::general.approved',1) }} {{ trans_choice('share::general.share',2) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-mb">
                                <a href="{{table_order_link('status')}}">
                                    <span class="sub-text">{{ trans_choice('share::general.status',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-mb">
                                <a href="{{table_order_link('share_product')}}">
                                    <span class="sub-text">{{ trans_choice('share::general.product',1) }}</span>
                                </a>
                            </div>
