...
@section('title')
    {{ trans_choice('share::general.share',1) }}  {{ trans_choice('share::general.product',2) }}
@endsection
@section('styles')
@stop
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ trans_choice('share::general.share',1) }}  {{ trans_choice('share::general.product',2) }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('share::general.share',1) }}  {{ trans_choice('share::general.product',2) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                @can('share.shares.products.create')
                    <a href="{{ url('share/product/create') }}" class="btn btn-info btn-sm">
                        <i class="fas fa-plus"></i> {{ trans_choice('core::general.add',1) }} {{ trans_choice('share::general.product',1) }}
                    </a>
                @endcan
                <div class="btn-group">
                    <div class="dropdown">
                ...
                <div class="card-tools">
                    <form class="form-inline ml-0 ml-md-3" action="{{url('share/product')}}">
            ...
            <div class="card-body p-0">
                <table id="data-table" class="table table-striped table-condensed table-hover">
                    ...
                    <tr>
                        ...
                        <th>
                            <a href="{{table_order_link('short_name')}}">
                                <span class="sub-text">{{ trans_choice('share::general.short_name',1) }}</span>
                            </a>
                        </th>
                        <th>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        @can('share.shares.products.edit')

                                            <a href="{{url('share/product/' . $key->id . '/edit')}}"
                                               class="dropdown-item">
                                        ...
                                        @can('share.shares.products.destroy')
                                            <a href="{{url('share/product/' . $key->id . '/destroy')}}"
