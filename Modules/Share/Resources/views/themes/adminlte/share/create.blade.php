...
@section('title')
    {{ trans_choice('core::general.add',1) }} {{ trans_choice('share::general.share',1) }}
@endsection
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('core::general.add',1) }} {{ trans_choice('share::general.share',1) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content" id="app">
        <form method="post" action="{{ url('share/store') }}">
            {{csrf_field()}}
    ...
    <script>
        ...
        var app = new Vue({
            ...
            data: {
                ...
                share_officer_id: parseInt("{{old('share_officer_id')}}"),
                share_product_id: parseInt("{{old('share_product_id')}}"),
                ...
                application_date: "{{old('application_date',date("Y-m-d"))}}",
