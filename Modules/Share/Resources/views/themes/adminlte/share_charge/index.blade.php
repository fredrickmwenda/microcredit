...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ trans_choice('share::general.share',1) }}  {{ trans_choice('share::general.charge',2) }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('share::general.share',1) }}  {{ trans_choice('share::general.charge',2) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="card-header">
                @can('share.shares.charges.create')
                    <a href="{{ url('share/charge/create') }}" class="btn btn-info btn-sm">
                        <i class="fas fa-plus"></i> {{ trans_choice('core::general.add',1) }} {{ trans_choice('share::general.charge',1) }}
                    </a>
                @endcan
                <div class="btn-group">
                    <div class="dropdown">
                ...
                <div class="card-tools">
                    <form class="form-inline ml-0 ml-md-3" action="{{url('share/charge')}}">
                    ...
                    <tr>
                        ...
                        <th>
                            <a href="{{table_order_link('share_charge_type_id')}}">
                                <span>{{ trans_choice('share::general.charge',1) }} {{ trans_choice('core::general.type',1) }}</span>
                            </a>
                        </th>
                        <th>
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        @can('share.shares.charges.edit')
                                            ...
                                            <a href="{{url('share/charge/' . $key->id . '/edit')}}" class="dropdown-item">
