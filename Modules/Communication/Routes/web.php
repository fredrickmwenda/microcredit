...
Route::prefix('communication')->group(function () {
    ...
    Route::get('all_sms', 'CommunicationController@getAllSms');
    Route::get('send_sms_form', 'CommunicationController@sendSmsForm');
    Route::post('process_sms_send', 'CommunicationController@processSmsSend');
    Route::get('all_jobs', 'CommunicationController@getAllJobs');
    Route::get('all_failed_jobs', 'CommunicationController@getAllFailedJobs');
    //sms gateway
