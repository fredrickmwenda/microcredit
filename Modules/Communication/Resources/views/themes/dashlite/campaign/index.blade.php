    ...
    <div class="nk-block-head-content">
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">{{ trans_choice('communication::general.campaign',2) }}</h3>
                    <div class="nk-block-des text-soft">
                        <p>{{number_format($data->total())}} {{ trans_choice('communication::general.campaign',2) }} {{ trans_choice('core::general.found',1) }}</p>
                    </div>
            ...
            <div class="card-inner-group">
                <div class="card-inner position-relative card-tools-toggle">
                    ...
                    <div class="card-search search-wrap" data-search="search">
                        <div class="card-body">
                            <form method="get"
                                  action="{{url('communication/campaign')}}">
                        ...
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col tb-col-md">
                                <a href="{{table_order_link('trigger_type')}}">
                                    <span class="sub-text">{{ trans_choice('communication::general.campaign',1) }} {{ trans_choice('core::general.type',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-md">
                                ...
                                <div class="nk-tb-col  tb-col-mb">
                                    @if(!empty($key->created_by))
                                        <a href="{{url('user/'.$key->created_by_id.'/show')}}">
                                            <span>{{$key->created_by->full_name}}</span>
                                        </a>
                                    @endif
                                </div>
                                <div class="nk-tb-col  tb-col-mb">
