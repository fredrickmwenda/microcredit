    ...
    <div class="nk-block-head-content">
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">{{ trans_choice('communication::general.log',2) }}</h3>
                    <div class="nk-block-des text-soft">
                        <p>{{number_format($data->total())}} {{ trans_choice('communication::general.log',2) }} {{ trans_choice('core::general.found',1) }}</p>
                    </div>
                ...
                <div class="card-inner p-0">
                    <div class="nk-tb-list nk-tb-ulist is-compact">
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col tb-col-mb">
                                <span class="sub-text">{{ trans_choice('communication::general.send_to',1) }}</span>
                            </div>
                            <div class="nk-tb-col tb-col-mb">
                            ...
                            <div class="nk-tb-col tb-col-md">
                                ...
                                <span class="sub-text">{{ trans_choice('communication::general.campaign',1) }} {{ trans_choice('core::general.name',1) }}</span>
