...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ trans_choice('communication::general.sms',1) }}  {{ trans_choice('communication::general.gateway',2) }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('communication::general.sms',1) }}  {{ trans_choice('communication::general.gateway',2) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="card-header">
                @can('communication.sms_gateways.create')
                    <a href="{{ url('communication/sms_gateway/create') }}" class="btn btn-info btn-sm">
                        <i class="fas fa-plus"></i> {{ trans_choice('core::general.add',1) }} {{ trans_choice('communication::general.gateway',1) }}
                    </a>
                @endcan
                <div class="btn-group">
                    <div class="dropdown">
                ...
                <div class="card-tools">
                    <form class="form-inline ml-0 ml-md-3" action="{{url('communication/sms_gateway')}}">
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        @can('communication.sms_gateways.edit')
                                            <a href="{{url('communication/sms_gateway/' . $key->id . '/edit')}}"
                                               class="dropdown-item">
                                        ...
                                        @can('communication.sms_gateways.destroy')
                                            <a href="{{url('communication/sms_gateway/' . $key->id . '/destroy')}}"
