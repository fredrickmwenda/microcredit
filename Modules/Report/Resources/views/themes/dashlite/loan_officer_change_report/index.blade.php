                ...
                <div class="nk-block">
                    <div class="nk-block-head">
                        <div class="nk-block-head-content">
                            <h4 class="nk-block-title">Loan Officer Change Audit Report</h4>
                        </div>
                    </div>

                    <div class="card">
                        <div class="card-inner">
                            <form method="GET" action="{{ url('report/loan-officer-changes') }}" class="row gy-3">
                                <div class="col-md-2">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="btn-group w-100" role="group">
                                            ...
                                            <a href="{{ url('report/loan-officer-changes') }}" class="btn btn-light">Reset</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
