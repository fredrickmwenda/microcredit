        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Savings Officer Change Audit Report</h3>
                </div>
                <div class="card-body">
                    <form method="GET" action="{{ url('report/savings-officer-changes') }}" class="form-inline">
                        ...
                        <a href="{{ url('report/savings-officer-changes') }}" class="btn btn-secondary">Reset</a>
                    </form>
                </div>
            </div>
        </div>
