...
class SavingsOfficerChangeReportController extends Controller
{
    /**
     * SavingsOfficerChangeReportController constructor.
     */
    public function __construct()
    {
        $this->middleware('auth');
        $this->middleware(['permission:savings.officer.change.report.index'])->only(['index']);
    }
    ...
    {
        $query = SavingsOfficerChangeAudit::with('savings', 'old_officer', 'new_officer', 'changed_by_user')
        ...
        return theme_view('report::savings_officer_change_report.index', compact('audits', 'officers', 'changedByUsers'));
    }
}
