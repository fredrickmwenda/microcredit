    ...
    <div class="nk-block-head-content">
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title"> {{ trans_choice('payroll::general.payroll',2) }}</h3>
                    <div class="nk-block-des text-soft">
                        <p>{{number_format($data->total())}} {{ trans_choice('payroll::general.payroll',2) }} {{ trans_choice('core::general.found',1) }}</p>
                    </div>
                                ...
                                <li class="nk-block-tools-opt">
                                    @can('payroll.payroll.create')
                                        <a href="{{ url('payroll/create') }}" class="btn btn-info btn-sm">
                                            {{ trans_choice('core::general.add',1) }} {{ trans_choice('payroll::general.payroll',2) }}
                                        </a>
                                    @endif
                                </li>
                            </ul>
                    ...
                    <div class="nk-tb-list nk-tb-ulist is-compact">
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col tb-col-md">
                                <span class="sub-text">{{ trans_choice('core::general.user',1) }}</span>
                            </div>
                            <div class="nk-tb-col tb-col-md">
                            ...
                            <div class="nk-tb-col tb-col-md">
                                <a href="{{table_order_link('gross_amount')}}">
                                    <span class="sub-text">{{ trans_choice('payroll::general.amount',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-md">
                                <a href="#">
                                    <span class="sub-text">{{ trans_choice('payroll::general.payment',1) }} {{ trans_choice('payroll::general.status',1) }}</span>
                                </a>
                            </div>
                            ...
                            <div class="nk-tb-item">
                                ...
                                <div class="nk-tb-col tb-col-mb">
                                    @if($key->payments >= $key->gross_amount)
                                        <span class="label label-success">{{trans_choice('payroll::general.paid', 1)}}</span>
                                    @elseif($key->payments < $key->gross_amount && $key->payments > 0)
                                        <span class="label label-warning">{{trans_choice('payroll::general.partially_paid', 1)}}</span>
                                    @else
                                        <span class="label label-danger">{{trans_choice('payroll::general.unpaid', 1)}}</span>
                                    @endif
                                </div>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <ul class="link-list-opt no-bdr">
                                                        ...
                                                        @can('payroll.payroll.edit')
                                                            <li>
                                                                <a href="{{url('payroll/' . $key->id . '/edit')}}">
