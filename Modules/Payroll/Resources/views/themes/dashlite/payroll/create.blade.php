...
@section('title')
    {{ trans_choice('core::general.add',1) }} {{ trans_choice('payroll::general.payroll',1) }}
@endsection
@section('content')
        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">  {{ trans_choice('core::general.add',1) }} {{ trans_choice('payroll::general.payroll',1) }}</h3>
...
@section('scripts')
    <script>
        ...
        var app = new Vue({
            ...
            data: {
                user_id: "{{old('user_id')}}",
                payroll_template_id: "{{old('payroll_template_id')}}",
                ...
                branches: branches,
                users: users,
                work_duration: "{{old('work_duration',0)}}",
                duration_unit: "{{old('duration_unit','Day')}}",
                amount_per_duration: "{{old('amount_per_duration',0)}}",
                total_duration_amount: "{{old('total_duration_amount',0)}}",
                date: '{{old('date',date("Y-m-d"))}}',
                total_allowances: "{{old('total_allowances',0)}}",
                total_deductions: "{{old('total_deductions',0)}}",
                gross_amount: "{{old('gross_amount',0)}}",
                selected_allowances: [],
                selected_deductions: []
