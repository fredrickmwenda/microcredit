    ...
    <div class="nk-block-head-content">
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title"> {{ trans_choice('payroll::general.item',2) }}</h3>
                    <div class="nk-block-des text-soft">
                        <p>{{number_format($data->total())}} {{ trans_choice('payroll::general.item',2) }} {{ trans_choice('core::general.found',1) }}</p>
                    </div>
                        ...
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col tb-col-md">
                                <a href="{{table_order_link('type')}}">
                                    <span class="sub-text">{{ trans_choice('payroll::general.type',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-md">
                            ...
                            <div class="nk-tb-item">
                                ...
                                <div class="nk-tb-col tb-col-mb">
                                    @if($key->type=='allowance')
                                        <span>{{trans_choice('payroll::general.allowance',1)}}</span>
                                    @else
                                        <span>{{trans_choice('payroll::general.deduction',1)}}</span>
                                    @endif
                                </div>
                                <div class="nk-tb-col tb-col-mb">
                                    <span>
