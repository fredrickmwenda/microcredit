    ...
    <div class="nk-block-head-content">
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title"> {{ trans_choice('asset::general.asset',2) }}</h3>
                    <div class="nk-block-des text-soft">
                        <p>{{number_format($data->total())}} {{ trans_choice('asset::general.asset',2) }} {{ trans_choice('core::general.found',1) }}</p>
                    </div>
                ...
                <div class="card-inner p-0">
                    <div class="nk-tb-list nk-tb-ulist is-compact">
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col tb-col-md">
                                <a href="{{table_order_link('asset_type_id')}}">
                                    <span class="sub-text">{{ trans_choice('core::general.type',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-md">
                                <a href="{{table_order_link('purchase_date')}}">
                                    <span class="sub-text">{{ trans_choice('asset::general.purchase',1) }} {{ trans('core::general.date') }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-md">
                                <a href="{{table_order_link('value')}}">
                                    <span class="sub-text">{{ trans_choice('asset::general.cost',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-md">
                                <a href="{{table_order_link('life_span')}}">
                                    <span class="sub-text">{{ trans_choice('asset::general.life_span',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-md">
                                <a href="{{table_order_link('salvage_value')}}">
                                    <span class="sub-text">{{ trans_choice('asset::general.salvage_value',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-md">

                                <span class="sub-text">{{ trans_choice('asset::general.current',1) }} {{ trans_choice('asset::general.value',1) }}</span>
                        ...
                        @foreach($data as $key)
                            <div class="nk-tb-item">
                                ...
                                <div class="nk-tb-col tb-col-mb">
                                    @if(!empty($key->branch))
                                        <span>{{$key->branch->name}}</span>
                                    @endif
                                </div>
                                <div class="nk-tb-col tb-col-mb">
                                    @if(!empty($key->type))
                                        <span>{{$key->type->name}}</span>
                                    @endif
                                </div>
                                <div class="nk-tb-col tb-col-mb">
