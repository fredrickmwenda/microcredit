        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title"> {{ trans_choice('core::general.add',1) }} {{ trans_choice('core::general.type',1) }}</h3>
    ...
    <script>
        var app = new Vue({
            ...
            data: {
                name: "{{old('name')}}",
                type: "{{old('type')}}",
                chart_of_account_fixed_asset_id: "{{old('chart_of_account_fixed_asset_id')}}",
                chart_of_account_asset_id: "{{old('chart_of_account_asset_id')}}",
                chart_of_account_contra_asset_id: "{{old('chart_of_account_contra_asset_id')}}",
                chart_of_account_expense_id: "{{old('chart_of_account_expense_id')}}",
                chart_of_account_liability_id: "{{old('chart_of_account_liability_id')}}",
                chart_of_account_income_id: "{{old('chart_of_account_income_id')}}",
                notes: `{{old('notes')}}`,
