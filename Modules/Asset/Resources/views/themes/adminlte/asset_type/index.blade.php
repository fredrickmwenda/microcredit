...
@section('title')
    {{ trans_choice('asset::general.asset',1) }} {{ trans_choice('core::general.type',2) }}
@endsection
@section('styles')
@stop
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ trans_choice('asset::general.asset',1) }} {{ trans_choice('core::general.type',2) }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('asset::general.asset',1) }} {{ trans_choice('core::general.type',2) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <form class="form-inline ml-0 ml-md-3" action="{{url('asset/type')}}">
            ...
            <div class="card-body table-responsive p-0">
                <table class="table  table-striped table-bordered table-hover table-condensed" id="data-table">
                    ...
                    @foreach($data as $key)
                        <tr>
                            <td>
                                <a href="{{url('asset/type/' . $key->id . '/show')}}">
                                    <span>{{$key->name}}</span>
                                </a>
                            </td>
                            <td>
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        @can('asset.assets.types.edit')
                                            <a href="{{url('asset/type/' . $key->id . '/edit')}}"
                                               class="dropdown-item">
                                        ...
                                        @can('asset.assets.types.destroy')
                                            <a href="{{url('asset/type/' . $key->id . '/destroy')}}"
