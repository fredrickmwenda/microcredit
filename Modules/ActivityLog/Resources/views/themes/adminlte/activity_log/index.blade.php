...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ trans_choice('activitylog::general.activity_log',2) }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('activitylog::general.activity_log',2) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <form class="form-inline ml-0 ml-md-3" action="{{url('activity_log')}}">
                    ...
                    <tr>
                        ...
                        <th>
                            <a href="{{table_order_link('created_at')}}">
                                {{ trans_choice('core::general.created_at',1) }}
                            </a>
                        </th>
