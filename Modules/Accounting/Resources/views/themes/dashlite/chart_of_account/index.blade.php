    ...
    <div class="nk-block-head-content">
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">{{ trans_choice('accounting::general.chart_of_account',2) }}</h3>
                    <div class="nk-block-des text-soft">
                        <p>{{number_format($data->total())}} {{ trans_choice('accounting::general.chart_of_account',2) }} {{ trans_choice('core::general.found',1) }}</p>
                    </div>
                                ...
                                <li class="nk-block-tools-opt">
                                    @can('accounting.chart_of_accounts.create')
                                        <a href="{{ url('accounting/chart_of_account/create') }}"
                                           class="btn btn-info btn-sm">{{ trans_choice('core::general.add',1) }} {{ trans_choice('core::general.account',1) }}</a>
                                    @endcan
                                </li>
                            </ul>
                        </div>
            ...
            <div class="card-inner-group">
                <div class="card-inner position-relative card-tools-toggle">
                    ...
                    <div class="card-search search-wrap" data-search="search">
                        <div class="card-body">
                            <form method="get"
                                  action="{{url('accounting/chart_of_account')}}">
                        ...
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col tb-col-md">
                                <a href="{{table_order_link('gl_code')}}">
                                    <span class="sub-text">{{ trans_choice('accounting::general.gl_code',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-md">
                                <a href="{{table_order_link('account_type')}}">
                                    <span class="sub-text">{{ trans_choice('core::general.account',1) }} {{ trans_choice('core::general.type',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-md">
                            ...
                            <div class="nk-tb-col tb-col-md">
                                <a href="{{table_order_link('allow_manual')}}">
                                    <span class="sub-text">{{ trans_choice('accounting::general.manual_entries_allowed',1) }}</span>
                                </a>
                            </div>
