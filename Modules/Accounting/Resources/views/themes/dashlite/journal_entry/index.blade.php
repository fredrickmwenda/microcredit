    ...
    <div class="nk-block-head-content">
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">{{ trans_choice('accounting::general.journal',1) }} {{ trans_choice('core::general.entry',2) }}</h3>
                    <div class="nk-block-des text-soft">
                        <p>{{number_format($data->total())}} {{ trans_choice('core::general.entry',2) }} {{ trans_choice('core::general.found',1) }}</p>
                    </div>
                                ...
                                <li class="nk-block-tools-opt">
                                    @can('accounting.journal_entries.create')
                                        <a href="{{ url('accounting/journal_entry/create') }}"
                                           class="btn btn-info btn-sm">{{ trans_choice('core::general.add',1) }} {{ trans_choice('core::general.entry',1) }}</a>
                                    @endcan
                                </li>
                            </ul>
                        </div>
            ...
            <div class="card-inner-group">
                <div class="card-inner position-relative card-tools-toggle">
                    ...
                    <div class="card-search search-wrap" data-search="search">
                        <div class="card-body">
                            <form method="get"
                                  action="{{url('accounting/journal_entry')}}">
                        ...
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col tb-col-mb">
                                <a href="{{table_order_link('id')}}">
                                    <span class="sub-text">{{ trans_choice('core::general.entry',1) }} {{ trans_choice('core::general.id',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-mb">
                                <a href="{{table_order_link('branch_id')}}">
                                    <span class="sub-text">{{ trans_choice('core::general.branch',1) }}/ Team</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-mb">
                                <a href="{{table_order_link('date')}}">
                                    <span class="sub-text">{{ trans_choice('core::general.transaction',1) }} {{ trans_choice('core::general.date',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-mb">
                                <a href="{{table_order_link('transaction_number')}}">
                                    <span class="sub-text">{{ trans_choice('core::general.transaction',1) }}#</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-mb">
                                <a href="{{table_order_link('transaction_type')}}">
                                    <span class="sub-text">{{ trans_choice('core::general.type',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-mb">
                                <span class="sub-text">{{ trans_choice('core::general.created_by',1) }}</span>
                            </div>
                            <div class="nk-tb-col tb-col-mb">
                                <a href="{{table_order_link('chart_of_account_id')}}">
                                    <span class="sub-text">{{ trans_choice('core::general.account',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-md">
                                <a href="{{table_order_link('debit')}}">
                                    <span class="sub-text">{{ trans_choice('accounting::general.debit',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-md">
                                <a href="{{table_order_link('credit')}}">
                                    <span class="sub-text">{{ trans_choice('accounting::general.credit',1) }}</span>
                                </a>
                            </div>
