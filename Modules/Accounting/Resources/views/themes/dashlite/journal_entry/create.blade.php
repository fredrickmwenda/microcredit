        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">{{ trans_choice('core::general.add',1) }} {{ trans_choice('accounting::general.journal',1) }} {{ trans_choice('core::general.entry',1) }}</h3>
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('payment_type_id') is-invalid @enderror" name="payment_type_id"
