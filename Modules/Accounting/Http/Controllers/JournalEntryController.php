...
class JournalEntryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data = JournalEntry::leftJoin("branches", "branches.id", "journal_entries.branch_id")
            ...
            ->selectRaw("journal_entries.id,journal_entries.created_by_id,journal_entries.date,journal_entries.debit,journal_entries.credit,journal_entries.transaction_number,branches.name branch,journal_entries.branch_id,chart_of_accounts.account_type,chart_of_accounts.name account_name,concat(users.first_name,' ',users.last_name) created_by")
            ->paginate($perPage)
