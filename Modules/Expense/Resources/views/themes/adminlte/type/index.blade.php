...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ trans_choice('expense::general.expense',1) }}  {{ trans_choice('expense::general.type',2) }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('expense::general.expense',1) }}  {{ trans_choice('expense::general.type',2) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="card-header">
                @can('expense.expenses.types.create')
                    <a href="{{ url('expense/type/create') }}" class="btn btn-info btn-sm">
                        <i class="fas fa-plus"></i> {{ trans_choice('core::general.add',1) }} {{ trans_choice('expense::general.type',1) }}
                    </a>
                @endcan
                <div class="btn-group">
                    <div class="dropdown">
            ...
            <div class="card-body p-0">
                <table id="data-table" class="table table-striped table-condensed table-hover">
                    ...
                    <tr>
                        ...
                        <th>
                            <a href="{{table_order_link('expense_chart_of_account')}}">
