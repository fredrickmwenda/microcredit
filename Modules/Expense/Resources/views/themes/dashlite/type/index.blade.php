    ...
    <div class="nk-block-head-content">
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title"> {{ trans_choice('expense::general.expense',1) }}  {{ trans_choice('expense::general.type',2) }}</h3>
                        ...
                        <div class="toggle-expand-content" data-content="pageMenu">
                            <ul class="nk-block-tools g-3">
                                ...
                                <li class="nk-block-tools-opt">
                                    @can('expense.expenses.types.create')
                ...
                <div class="card-inner p-0">
                    <div class="nk-tb-list nk-tb-ulist is-compact">
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col tb-col-md">
                                <a href="{{table_order_link('expense_chart_of_account_id')}}">
                                    <span class="sub-text">{{ trans_choice('accounting::general.expense',1) }}</span>
                                </a>
                            </div>
                        ...
                        @foreach($data as $key)
                            <div class="nk-tb-item">
                                ...
                                <div class="nk-tb-col tb-col-mb">
                                    <span>{{$key->expense_chart_of_account}}</span>
                                </div>
