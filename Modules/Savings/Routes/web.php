...
Route::prefix('savings')->group(function () {
    ...
    Route::get('deposit_report', 'SavingsController@getSavingsDepositReport');
    Route::get('add_saving_deposit', 'SavingsController@addSavingDeposit');
    Route::get('get_savings_list', 'SavingsController@getSavingsList');
    Route::get('get_savings_detail', 'SavingsController@getSavingsDetail');
    ...
    Route::post('approve_reject_savings_deposit', 'SavingsController@approve_reject_savings_deposit');
    ...
    //deposits
    Route::post('deposit/store_deposit2', 'SavingsController@store_deposit2'); //store directly select client/savings
