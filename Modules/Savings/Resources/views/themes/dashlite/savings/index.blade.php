    ...
    <div class="nk-block-head-content">
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">{{ trans_choice('savings::general.savings',2) }}</h3>
                    <div class="nk-block-des text-soft">
                        <p>{{number_format($data->total())}} {{ trans_choice('savings::general.savings',2) }} {{ trans_choice('core::general.found',1) }}</p>
                    </div>
                        ...
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col tb-col-mb">
                                <a href="{{table_order_link('savings_officer')}}">
                                    <span class="sub-text">{{ trans_choice('savings::general.savings_officer',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-mb">
                            ...
                            <div class="nk-tb-col tb-col-mb">
                                <a href="{{table_order_link('interest_rate')}}">
                                    <span class="sub-text">{{ trans_choice('savings::general.interest_rate',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-mb">
                                <a href="{{table_order_link('balance')}}">
                                    <span class="sub-text">{{ trans_choice('savings::general.balance',1) }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-mb">
                                <a href="{{table_order_link('status')}}">
                                    <span class="sub-text">{{ trans('core::general.status') }}</span>
                                </a>
                            </div>
                            <div class="nk-tb-col tb-col-mb">
                                <a href="{{table_order_link('product')}}">
                                    <span class="sub-text">{{ trans_choice('savings::general.product',1) }}</span>
                                </a>
                            </div>
